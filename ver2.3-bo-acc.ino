...
void setup()
{
  ...
  lcd.begin();
  lcd.home();
  Blynk.begin(auth, ssid, pass, IPAddress(192, 168, 0, 20  ), 8080);
  pinMode(5, INPUT);
  pinMode(4, INPUT);
...
void NhietDo()
{
  ...
  String DoAm = String(h) + String("%");
  String NhietDo = String(t) + String("°C");
  Firebase.setString("/ESP8266/NHIET DO/Value", NhietDo);
  Firebase.setString("/ESP8266/DO AM/Value", DoAm);
